        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <?php  }else{ ?>
                ...
                <a class="nav-item nav-link active" href="<?php echo site_url("Welcome/AddItem"); ?>">Add Menu Item</a>
      ...
      <div class="container-fluid view">
        ...
        <div class='con'>
                    ...
                    <form method='POST'>
                      ...
                      <div class="form-group">
                              <label for="item">Item Picture</label>
                              <input type="file" class="form-control" id="item" name="item" required>
                      </div>
                     
                      
                      <div class="form-group">
                          <input type="submit" name="add" id="add" class="btn btn-info" value="Add Item">
                      </div>
                    </form>
