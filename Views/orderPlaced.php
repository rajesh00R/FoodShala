  ...
  <a class="navbar-brand text-light font-weight-bold" href="<?php echo site_url(); ?>">FoodShala</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            <a class="nav-item nav-link active" href="<?php echo site_url(); ?>">Menu <span class="sr-only">(current)</span></a>
            <?php
      ...
      <div class="container view" id="pr">
        <hr>
        <!--form for order sucessfull-->
        <div class="alert alert-success">
          <strong>Success:</strong> Your order has been successfully placed.
        </div>
      
        <center> <a class="btn" href="<?php echo site_url(); ?>" role="button">Go To Home</a></center>
