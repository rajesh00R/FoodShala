...
<html lang="en">
  ...
  <a class="navbar-brand text-light font-weight-bold" href="<?php echo site_url(); ?>">FoodShala</a>
          ...
          <div class="navbar-nav">
            ...
            <?php 
              if(empty($sess_rn)){ ?>
                ...
                <a class="nav-item nav-link active" href="<?php echo site_url("Welcome/registerRest"); ?>">Register your Restaurant</a>
            <?php  }else{ ?>
      ...
      <div class="container jumbotron view">
        <h2>Restaurant Registration</h2><hr>
        <form method='POST' action="#">
                ...
                <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="address" name="address" rows="2" required> </textarea>
                </div>
                <div class="form-group">
                        <label for="detail">Other Details</label>
                        <textarea type="text" class="form-control" id="detail" name="detail" rows="2"> </textarea>
                </div>
